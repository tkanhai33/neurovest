...
for (const file of required) {
  if (!existsSync(file)) throw new Error(`Missing manual backend status refresh button shell file: ${file}`);
}
...
console.log("PASS: Manual backend status refresh button shell verified.");
