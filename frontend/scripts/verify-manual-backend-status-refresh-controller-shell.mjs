...
for (const file of required) {
  if (!existsSync(file)) throw new Error(`Missing manual backend status refresh controller shell file: ${file}`);
}
...
console.log("PASS: Manual backend status refresh controller shell verified.");
