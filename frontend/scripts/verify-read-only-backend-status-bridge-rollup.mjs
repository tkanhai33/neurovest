...
for (const file of required) {
  if (!existsSync(file)) throw new Error(`Missing read-only backend status bridge rollup file: ${file}`);
}
...
console.log("PASS: Read-only backend status bridge rollup certified.");
