...
ROOT = Path(".").resolve()
OUT = ROOT / "runtime/certifications/phase13g_portfolio_chain_dashboard_certification_latest.json"
...
steps = {
    "patch": run(["python3", "scripts/phase13g_add_portfolio_chain_to_dashboard.py"]),
...
checks = {
    ...
    "dashboard_txt_has_portfolio_chain": "PORTFOLIO SERVICE CHAIN GRAPH" in dash_text,
...
report = {
    "phase": "13G_PORTFOLIO_CHAIN_DASHBOARD_CERTIFICATION",
