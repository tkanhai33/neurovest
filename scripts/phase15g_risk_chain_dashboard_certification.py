...
ROOT = Path(".").resolve()
OUT = ROOT / "runtime/certifications/phase15g_risk_chain_dashboard_certification_latest.json"
...
steps = {
    "patch": run(["python3", "scripts/phase15g_add_risk_chain_to_dashboard.py"]),
...
risk_chain = dash.get("risk_service_chain", {})
...
checks = {
    ...
    "dashboard_has_risk_chain": "risk_service_chain" in dash,
    ...
    "risk_chain_counts_ok": risk_chain.get("node_count") == 5 and risk_chain.get("edge_count") == 4,
    "dashboard_txt_has_risk_chain": "RISK SERVICE CHAIN GRAPH" in dash_text,
...
report = {
    "phase": "15G_RISK_CHAIN_DASHBOARD_CERTIFICATION",
