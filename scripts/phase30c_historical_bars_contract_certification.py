...
OUT = ROOT / "runtime/certifications/phase30c_historical_bars_contract_certification_latest.json"
...
steps = {
    "phase30b_cert": run([
        "python3",
        "scripts/phase30b_yfinance_provider_selection_snapshot.py"
    ]),
    "build_contract": run([
        "python3",
        "scripts/phase30c_historical_bars_contract.py"
    ]),
...
contract_path = ROOT / "runtime/strategy_candidate_sandbox/historical_bars_contract_v1.json"
txt_path = ROOT / "runtime/strategy_candidate_sandbox/historical_bars_contract_v1.txt"

contract = json.loads(contract_path.read_text()) if contract_path.exists() else {}
bar_shape = contract.get("bar_shape", {})
flags = contract.get("execution_flags", {})

checks = {
    "phase30b_certified": '"certified": true' in steps["phase30b_cert"]["stdout"],
    ...
    "schema_id_exists": contract.get("schema_id") == "historical_bars_contract_v1",
    "selected_provider_yfinance": contract.get("selected_provider") == "yfinance",
    "bar_has_timestamp": "timestamp" in bar_shape,
    "bar_has_open": "open" in bar_shape,
    "bar_has_high": "high" in bar_shape,
    "bar_has_low": "low" in bar_shape,
    "bar_has_close": "close" in bar_shape,
    "bar_has_volume": "volume" in bar_shape,
...
report = {
    "phase": "30C_HISTORICAL_BARS_CONTRACT_CERTIFICATION",
