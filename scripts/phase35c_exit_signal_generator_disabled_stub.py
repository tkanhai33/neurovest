...
GENERATOR = SANDBOX_DIR / "exit_signal_generator_disabled_stub.py"
OUT_DIR = ROOT / "runtime/strategy_candidate_sandbox"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT = OUT_DIR / "35C_exit_signal_generator_disabled_stub_latest.json"

PHASE = "35C_EXIT_SIGNAL_GENERATOR_DISABLED_STUB"
...
try:
    ...
    from backend.app.stacks.strategy_candidate_sandbox.exit_signal_rule_contract import build_disabled_exit_rule_contract
    from backend.app.stacks.strategy_candidate_sandbox.exit_signal_generator_disabled_stub import (
        generate_exit_signals_disabled,
        validate_exit_signal_generator_disabled,
    )
    ...
    generated = generate_exit_signals_disabled("candidate_31e_stub_001", "AAPL", bars, rule)
    validation = validate_exit_signal_generator_disabled(generated)
    ...
    result["generation_summary"] = {
        ...
        "exit_signal_generation_enabled": generated.get("exit_signal_generation_enabled"),
    ...
    result["checks"]["exit_generation_disabled"] = generated.get("exit_signal_generation_enabled") is False
