...
OUT = SANDBOX / "37C_trade_simulation_enablement_gate_pipeline_rollup_certification_latest.json"
PHASE = "37C_TRADE_SIMULATION_ENABLEMENT_GATE_PIPELINE_ROLLUP_CERTIFICATION"

ARTIFACTS = [
    "37A_trade_simulation_enablement_gate_contract_stub_latest.json",
    "37B_trade_simulation_enablement_gate_validation_stub_latest.json",
]
...
try:
    ...
    result["pipeline_summary"] = {
        "from": "37A_TRADE_SIMULATION_ENABLEMENT_GATE_CONTRACT_STUB",
        "to": "37B_TRADE_SIMULATION_ENABLEMENT_GATE_VALIDATION_STUB",
        "certified_capability": [
            "trade simulation enablement gate contract",
            "locked trade simulation gate validation",
            "unsafe trade simulation enablement rejection",
        ],
        "current_behavior": [
        ...
        "next_recommended_phase": "37D_HANDOFF_BUNDLE_REFRESH",
    }
