...
OUT = SANDBOX / "38D_handoff_bundle_refresh_latest.json"

PHASE = "38D_HANDOFF_BUNDLE_REFRESH"
...
REQUIRED_PHASES = {
    ...
    "38A_RISK_GATE_CONTRACT_STUB",
    "38B_RISK_GATE_VALIDATION_STUB",
...
bundle = {
    ...
    "stage": "Risk Gate Certified Locked",
    "latest_confirmed_phase": "38C_RISK_GATE_PIPELINE_ROLLUP_CERTIFICATION",
    ...
    "current_capabilities": [
        ...
        "risk gate locked",
        "unsafe risk approval rejection",
    ],
    "still_disabled": [
    ...
    "next_recommended_phase": "39A_MASTER_SANDBOX_GATE_WIREGRAPH_REFRESH",
    "next_phase_rule": "Refresh the dependency graph to include strategy, simulation, and risk gates. Do not enable runtime.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
