...
OUT = SANDBOX / "43C_handoff_bundle_refresh_latest.json"

PHASE = "43C_HANDOFF_BUNDLE_REFRESH"

REQUIRED_PHASES = {
    "42C_HANDOFF_BUNDLE_REFRESH",
    "43A_QWEN_CONTEXT_RESPONSE_CONTRACT_STUB",
    "43B_QWEN_CONTEXT_RESPONSE_CONTRACT_ROLLUP_CERTIFICATION",
}

bundle = {
    "phase": PHASE,
    "created_at": datetime.now(UTC).isoformat(),
    "stage": "Qwen Read-Only Response Contract Certified",
    "latest_confirmed_phase": "43B_QWEN_CONTEXT_RESPONSE_CONTRACT_ROLLUP_CERTIFICATION",
    ...
    "current_capabilities": [
        ...
        "Qwen read-only response contract",
        "Qwen can summarize certified architecture",
        "Qwen can list locked gates",
        "Qwen can recommend read-only next phase",
    ],
    "still_disabled": [
        "Qwen actions",
        "Qwen file writes",
    ...
    "next_recommended_phase": "44A_QWEN_READ_ONLY_RESPONSE_SAMPLE_STUB",
    "next_phase_rule": "Generate one sample Qwen read-only architecture response. No writes or execution by Qwen.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
