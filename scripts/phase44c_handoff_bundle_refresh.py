...
OUT = SANDBOX / "44C_handoff_bundle_refresh_latest.json"

PHASE = "44C_HANDOFF_BUNDLE_REFRESH"

REQUIRED_PHASES = {
    "43C_HANDOFF_BUNDLE_REFRESH",
    "44A_QWEN_READ_ONLY_RESPONSE_SAMPLE_STUB",
    "44B_QWEN_READ_ONLY_RESPONSE_SAMPLE_ROLLUP_CERTIFICATION",
}

bundle = {
    "phase": PHASE,
    "created_at": datetime.now(UTC).isoformat(),
    "stage": "Qwen Read-Only Response Sample Certified",
    "latest_confirmed_phase": "44B_QWEN_READ_ONLY_RESPONSE_SAMPLE_ROLLUP_CERTIFICATION",
    ...
    "current_capabilities": [
        ...
        "Qwen certified sample response",
        "Qwen can summarize locked architecture only",
        "Qwen can recommend read-only next phase only",
    ],
    "still_disabled": [
        "Qwen actions",
        "Qwen file writes",
    ...
    "next_recommended_phase": "45A_QWEN_READ_ONLY_ARCHITECTURE_SUMMARY_GATE_STUB",
    "next_phase_rule": "Create Qwen architecture summary gate only. No writes or execution.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
