...
OUT = SANDBOX / "46C_handoff_bundle_refresh_latest.json"

PHASE = "46C_HANDOFF_BUNDLE_REFRESH"

REQUIRED_PHASES = {
    "45C_HANDOFF_BUNDLE_REFRESH",
    "46A_QWEN_READ_ONLY_MISSING_CONTEXT_DETECTOR_STUB",
    "46B_QWEN_READ_ONLY_MISSING_CONTEXT_DETECTOR_ROLLUP_CERTIFICATION",
}

bundle = {
    "phase": PHASE,
    "created_at": datetime.now(UTC).isoformat(),
    "stage": "Qwen Read-Only Missing Context Detector Certified",
    "latest_confirmed_phase": "46B_QWEN_READ_ONLY_MISSING_CONTEXT_DETECTOR_ROLLUP_CERTIFICATION",
    ...
    "next_recommended_phase": "47A_QWEN_READ_ONLY_RECOMMENDATION_FILTER_STUB",
    "next_phase_rule": "Create Qwen recommendation filter only. No writes, execution, or implementation instructions.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
