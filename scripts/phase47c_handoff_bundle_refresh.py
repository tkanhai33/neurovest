...
OUT = SANDBOX / "47C_handoff_bundle_refresh_latest.json"

PHASE = "47C_HANDOFF_BUNDLE_REFRESH"

REQUIRED_PHASES = {
    "46C_HANDOFF_BUNDLE_REFRESH",
    "47A_QWEN_READ_ONLY_RECOMMENDATION_FILTER_STUB",
    "47B_QWEN_READ_ONLY_RECOMMENDATION_FILTER_ROLLUP_CERTIFICATION",
}

bundle = {
    "phase": PHASE,
    "created_at": datetime.now(UTC).isoformat(),
    "stage": "Qwen Read-Only Recommendation Filter Certified",
    "latest_confirmed_phase": "47B_QWEN_READ_ONLY_RECOMMENDATION_FILTER_ROLLUP_CERTIFICATION",
    ...
    "current_capabilities": [
        ...
        "Qwen safe next-phase recommendation",
    ],
    "still_disabled": [
        "Qwen file requests",
    ...
    "next_recommended_phase": "48A_QWEN_READ_ONLY_RESPONSE_VALIDATOR_STUB",
    "next_phase_rule": "Create Qwen response validator only. No writes, execution, or implementation instructions.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
...
try:
    ...
    bundle["pipeline_summary"] = {
        ...
        "through": "47B_QWEN_READ_ONLY_RECOMMENDATION_FILTER_ROLLUP_CERTIFICATION",
        "to": "47C_HANDOFF_BUNDLE_REFRESH",
        "certified_capability": [
            "Qwen recommendation filter exists",
            "safe recommendation types are controlled",
            "unsafe recommendation types remain blocked",
            "read-only reasoning boundary preserved",
            "no execution capability introduced",
        ],
        "current_behavior": [
            "architecture summaries only",
            "locked gate explanations only",
            "missing context reporting only",
            "safe recommendation filtering only",
        ],
        "next_recommended_phase": "48A_QWEN_READ_ONLY_RESPONSE_VALIDATOR_STUB",
    }
