...
OUT = SANDBOX / "51C_handoff_bundle_refresh_latest.json"

PHASE = "51C_HANDOFF_BUNDLE_REFRESH"

REQUIRED_PHASES = {
    "50C_HANDOFF_BUNDLE_REFRESH",
    "51A_QWEN_READ_ONLY_ARCHITECTURE_LOOP_BOUNDARY_STUB",
...
bundle = {
    ...
    "stage": "Qwen Read-Only Architecture Loop Boundary Certified",
    "latest_confirmed_phase": "51B_QWEN_READ_ONLY_ARCHITECTURE_LOOP_BOUNDARY_ROLLUP_CERTIFICATION",
    ...
    "next_recommended_phase": "52A_QWEN_READ_ONLY_FINAL_GUARDRAIL_SUMMARY_STUB",
    "next_phase_rule": "Create Qwen read-only guardrail summary only. No writes, execution, or implementation instructions.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
...
try:
    ...
    bundle["pipeline_summary"] = {
        ...
        "through": "51B_QWEN_READ_ONLY_ARCHITECTURE_LOOP_BOUNDARY_ROLLUP_CERTIFICATION",
        "to": "51C_HANDOFF_BUNDLE_REFRESH",
        ...
        "current_behavior": [
            "read-only architecture loop only",
