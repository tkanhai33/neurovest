...
OUT = SANDBOX / "52C_handoff_bundle_refresh_latest.json"

PHASE = "52C_HANDOFF_BUNDLE_REFRESH"

REQUIRED_PHASES = {
    "51C_HANDOFF_BUNDLE_REFRESH",
    "52A_QWEN_READ_ONLY_FINAL_GUARDRAIL_SUMMARY_STUB",
...
bundle = {
    ...
    "stage": "Qwen Read-Only Final Guardrail Summary Certified",
    "latest_confirmed_phase": "52B_QWEN_READ_ONLY_FINAL_GUARDRAIL_SUMMARY_ROLLUP_CERTIFICATION",
    ...
    "next_recommended_phase": "53A_QWEN_READ_ONLY_HANDOFF_FREEZE_STUB",
    "next_phase_rule": "Freeze Qwen read-only handoff state only. No writes, execution, or implementation instructions.",
    "artifacts": [],
    "checks": {},
    "errors": [],
    "certified": False,
...
try:
    ...
    bundle["pipeline_summary"] = {
        ...
        "through": "52B_QWEN_READ_ONLY_FINAL_GUARDRAIL_SUMMARY_ROLLUP_CERTIFICATION",
        "to": "52C_HANDOFF_BUNDLE_REFRESH",
        ...
        "current_behavior": [
            "read-only guardrail summary only",
